<?php
/**
 * `ttm/most-read` render: manually-flagged posts for the current category archive (01 §4.29).
 * `source=views` is not implemented (Q6) and is treated as `manual`. Not a category archive, or
 * zero flagged posts -> ''.
 *
