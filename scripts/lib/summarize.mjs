 ...
 *
 * @param {Array<{id: number|string, slug: string, report: {textEqual: boolean, freeform: number, html: number}}>} results
 * @param {{allowFreeform?: boolean, allowTextMismatch?: boolean}}                                                 [options]
...
export function summarizeResults( results, options = {} ) {
	const { allowFreeform = false, allowTextMismatch = false } = options;
	let failed = false;
	const messages = [];
